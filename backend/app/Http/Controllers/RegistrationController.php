...
class RegistrationController extends Controller
{
    ...
    public function store(RegistrationRequest $request): RegistrationResource { return new RegistrationResource($this->registrations->create($request->user(), $request->validated())); }
